...
def main():
    ...
    try:
        ...
        for i_episode in range(num_episodes):
            ...
            for t in count():
                done0, reward0 = agent_list[0].train(memory_list[0], agent_list[0], True)
                
                if advice_prob > random.random():
                    done1, reward1 = agent_list[1].train(memory_list[2], agent_list[2], True)   # small gamma
                    done2, reward2 = agent_list[2].train(memory_list[1], agent_list[1], True)   # large gamma
                else:
                    done1, reward1 = agent_list[1].train(memory_list[1], agent_list[1], True)
                    done2, reward2 = agent_list[2].train(memory_list[2], agent_list[2], True)
...
class DQNagent():
    ...
    def train(self, memory, agent, train):
